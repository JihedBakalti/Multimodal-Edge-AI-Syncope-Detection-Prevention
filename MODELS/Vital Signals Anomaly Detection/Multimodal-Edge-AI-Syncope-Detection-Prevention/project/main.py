...
def main() -> None:
    ...
    if not model_path.exists():
        print(
            ...
            "        Get PPGPT_500k_iters.zip from HeartGPT Model_files, unzip to this path:\n"
            "        https://github.com/harryjdavies/HeartGPT/tree/main/Model_files\n"
            "        Or:  python project/fetch_ppgpt_weights.py",
            file=sys.stderr,
        )
        sys.exit(1)
